<div class="flex p-4 {{$loop->last ? '' : 'border-b border-b-gray-400'}}">
    ...
    <div class="mr-2 flex-shrink-0">
        <a href="{{$tweek->user->path()}}">
            <img src="{{$tweek->user->avatar}}" alt="Avatar" class="rounded-full mr-2" width="50" height="50">
        </a>
    </div>
    ...
    <div>
        ...
        <div class="flex">
            <div class="flex item-center mr-4 {{$tweek->isLikedBy(current_user())  ?  'text-blue-500' : 'text-gray-500'}}">
            ...
            <div class="flex item-center {{$tweek->isDislikedBy(current_user())  ?  'text-blue-600' : 'text-gray-500'}}">
                <svg viewBox="0 0 20 20" class=" mr-1 w-3">
                    <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                        <g class="fill-current">
